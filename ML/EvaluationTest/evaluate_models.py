...
class TFLiteModel:
    ...
    def evaluate(self,y_true_labels,y_pred_labels ):
        cm_normalised = self.plot_confusion_matrix(y_true_labels, y_pred_labels)
        self.show_classification_report(y_true_labels, y_pred_labels)
        self.show_metrics_per_class(y_true_labels,y_pred_labels, cm_normalised)


    def plot_confusion_matrix(self,y_true_labels, y_pred_labels, save_to_folder=True):
    ...
    def show_classification_report(self,y_true_labels, y_pred_labels):
        print(classification_report(y_true_labels, y_pred_labels))

    def show_metrics_per_class(self,y_truth,y_pred_labels,cm_normalised, save_to_folder=True):
        accuracies = cm_normalised.diagonal()
        precisions = precision_score(y_truth, y_pred_labels, average=None)
        recalls = recall_score(y_truth, y_pred_labels, average=None)
        f1_scores = f1_score(y_truth, y_pred_labels, average=None)
...
if __name__ == "__main__":    
    ...
    #Evaluate model
    model.evaluate(y_true_labels,y_pred_labels)
